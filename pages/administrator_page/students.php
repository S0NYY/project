                    ...
                    <?php 
                        ...
                        while($row = mysqli_fetch_assoc($getStudents)) :
                            ...
                            if ($getCourseTitleByGroupId) :
                                ...
                                $status_id = $getStatusByStudentId['status_id'];
                        ...
                        <tr>
                          ...
                          [
                            ...
                            <td><?php 
                            if($status_id==1) {
                                echo '<p style="color:#00CC00;">' . $status_title . '</p>';}
                                elseif ($status_id == 2){
                                    echo '<p style="color:orange;">' . $status_title . '</p>';
                                } 
                                else{
                                    echo '<p style="color:red;">' . $status_title . '</p>';
                                }?></td>
                            <td><a href="<?php urlGenerator( 
                          [
                            'mode' => 'view', 
                            'page' => 'student_profile_preview', 
                            'student' => $student_id 
                          ]
