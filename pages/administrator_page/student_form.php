...
<div class="row">
    <div class="col-md-6">
        <div class="card" style="min-height: 484px;">
            <div class="card-header"><h3>სტუდენტი</h3></div>
            <div class="card-body">
                <form class="forms-sample" action="index.php?page=insert_student" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="exampleInputMobile" placeholder="ID number" name="student_show_id">
                        </div>
                    </div>
                    <div class="form-group row">
